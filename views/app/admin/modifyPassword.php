	...
	<main>
		<div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
			<div class="row">
				...
				<div class="col-md-6">
					<form action="index.php?c=admin&a=updatePassword" method="POST" class="row p-3 g-3 " style="margin-top: 100px;">
						<div class="col-md-12 title">
							<h2 class="text-center">Cambiar Contraseña</h2>
							<input type="text" name="id" class="form-control" value="<?php echo $_SESSION["admin"]["id"]; ?>" hidden>
						</div>
						<div class="col-md-12 col-sm-12">
							<input type="text" name="psswd" id="psswd" class="form-control" value="<?php echo $_SESSION["admin"]["contrasena"]; ?>" hidden>
						</div>
						<div class="col-md-12 col-sm-12">
