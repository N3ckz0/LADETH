	...
	<section class="d-flex flex-column justify-content-center align-items-center">
		...
		<div class="row w-100">
			...
			<div class="col-xl-8 col-lg-12 col-md-12 col-sm-12">
				<h3 class="d5splay-4">Valores</h3>
				<div id="carouselExampleDark" class="carousel carousel-dark slide mb-2">
				  ...
				  <div class="carousel-inner">
				    <div class="carousel-item active" data-bs-interval="10000">
				      <img src="assets/img/img3.jpg" class="d-block w-100 img-responsive" alt="...">
				      <div class="carousel-caption d-none d-md-block bg-grey">
				        <h5>Respeto</h5>
				        <p>Para LADETH es importante que entre consultores y clientes exista el respeto mutuo para generar una buena comunicación y convivencia.</p>
				      </div>
				    </div>
				    ...
				    <div class="carousel-item">
				      ...
				      <div class="carousel-caption d-none d-md-block bg-grey">
				        <h5>Empatía</h5>
				        <p>Cada consultor debe tener la capacidad de comprender las necesidades del cliente, de escucharlos y brindar una solución efectiva para cumplir con sus expectativas.</p>
				      </div>
				    </div>
				    <div class="carousel-item">
				      <img src="assets/img/img3.jpg" class="d-block w-100 img-responsive" alt="...">
				    ...
				    <div class="carousel-item">
				      ...
				      <div class="carousel-caption d-none d-md-block bg-grey">
				        <h5>Compromiso</h5>
				        <p>Todo el equipo de LADETH tiene un compromiso con sus clientes en cumplir con todas las expectativas de resolución de las situaciones relacionadas con los temas de Capital Humano.</p>
				      </div>
				    </div>
				  </div>
